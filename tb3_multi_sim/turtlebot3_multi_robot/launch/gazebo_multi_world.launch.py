...
def generate_launch_description():
    ...
    gazebo_path1 = os.path.join(get_package_share_directory('turtlebot3_gazebo'), 'models')
    gazebo_path2 = os.path.join(get_package_share_directory('turtlebot3_multi_robot'), 'models')
    if 'GAZEBO_MODEL_PATH' in os.environ:
        os.environ['GAZEBO_MODEL_PATH'] += ":" + gazebo_path1 + ":" + gazebo_path2
    else :
        os.environ['GAZEBO_MODEL_PATH'] = gazebo_path1 + ":" + gazebo_path2
